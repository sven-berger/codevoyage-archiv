<?php
require_once($_SERVER['DOCUMENT_ROOT'] . "/4.0.0/includes/session.php");
...
<body class="d-flex flex-column vh-100">
    <div class="d-flex flex-grow-1">
        <?php require_once($_SERVER['DOCUMENT_ROOT'] . "/4.0.0/includes/seitenleiste.php"); ?>
        <main class="content bg-white p-3 flex-grow-1">
            <?php require_once($_SERVER['DOCUMENT_ROOT'] . "/4.0.0/includes/navigation.php"); ?>
