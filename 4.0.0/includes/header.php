...
<head>
  ...
  <style>
    ...
    @font-face {
      font-family: 'Roboto';
      src: url('/4.0.0/assets/fonts/roboto/Roboto-Regular.ttf') format('ttf');
      font-weight: 400;
      font-style: normal;
    }
    ...
    @font-face {
      font-family: 'Roboto';
      src: url('/4.0.0/assets/fonts/roboto/Roboto-Bold.ttf') format('ttf');
      font-weight: 700;
      font-style: normal;
    }
  </style>
  ...
  <!-- Eigene JSON-Liste -->
  <script src="/4.0.0/assets/jsonList.js"></script>
</head>
