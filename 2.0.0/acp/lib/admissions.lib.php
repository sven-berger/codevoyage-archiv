<?php 
    require_once "$_SERVER[DOCUMENT_ROOT]" . "/2.0.0/acp/lib/class/admission/admissionadd.class.php";
    require_once "$_SERVER[DOCUMENT_ROOT]" . "/2.0.0/acp/lib/forms/admission/admisionadd.form.php";
    ...
    require_once "$_SERVER[DOCUMENT_ROOT]" . "/2.0.0/acp/lib/class/admission/admissionlist.class.php";
    require_once "$_SERVER[DOCUMENT_ROOT]" . "/2.0.0/acp/lib/forms/admission/admisionlistedit.form.php";
